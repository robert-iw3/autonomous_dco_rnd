...
- [x] **Staging path consolidation** -- Authoritative path: `mlops/data/staging/`. Stale `autonomous_dco_rnd/data/staging/` removed. `STAGING_DIR` corrected in `tests/test_s3_query_alignment.py` and `tests/mlops_eval_minilab/eval_config.py`.
