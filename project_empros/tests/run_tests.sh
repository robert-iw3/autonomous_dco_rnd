...
TRIGGERS=(
    ...
    "mlops/data/:mlops"
    "analytics/llm_hunter/agents/controls|analytics/llm_hunter/agents/verdict_ledger|analytics/llm_hunter/agents/energy_accounting|analytics/llm_hunter/agents/active_learning|analytics/llm_hunter/agents/calibration_ledger|analytics/llm_hunter/agents/bias_audit:governance"
    ...
    "mlops/benchmarks/|mlops/scripts/09_benchmark_runner|tests/lab_benchmarks:bench"
