...
- **NC-10-VERDICT-LINEAGE** — Tamper-evident verdict lineage. *Evidence:* artifacts/NC-10-VERDICT-LINEAGE.md — response.py L168-L178; controls.py L480-L483,L486-L496; verdict_ledger.py L37-L46
- **NC-11-ENERGY-ACCOUNTING** — Per-run inference energy accounting. *Evidence:* artifacts/NC-11-ENERGY-ACCOUNTING.md — response.py L183-L187; controls.py L506-L517; energy_accounting.py L23-L33
