...
- **AI-GROUNDING** — Confabulated-evidence grounding. *Evidence:* artifacts/AI-GROUNDING.md — controls.py L82-L112
- **AI-MEMORY-TTL** — Immunity-memory TTL / expiry. *Evidence:* artifacts/AI-MEMORY-TTL.md — controls.py L145-L173
- **AI-PROVENANCE** — AI-origin provenance disclosure. *Evidence:* artifacts/AI-PROVENANCE.md — controls.py L176-L190
...
- **NC-2-CALIBRATION** — Confidence-calibration ledger. *Evidence:* artifacts/NC-2-CALIBRATION.md — calibration_ledger.py L26-L38,L55-L77
