#!/usr/bin/env bash
# arkime-ml-gateway (network_tap) Test Workbench
# ===============================================================================
# Tier 0 - Schema-contract + transmission-layer conformance (pytest, no containers)
# Tier 1 - Rust build/compile + algorithmic validation (cargo check && cargo test, containerized)
#
# Usage:
...
if $RUN_TIER1; then
    echo ""
    echo "=== Tier 1: Rust build/compile + algorithmic validation (cargo check && cargo test) ==="
