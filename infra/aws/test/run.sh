#!/usr/bin/env bash
# Nexus AWS Connectors (vpc/cloudtrail/guardduty) Test Workbench
# ===============================================================================
...
#          (terraform + moto + checkov/cfn-lint, containerized)
#
# Usage:
...
if $RUN_TIER2; then
    echo ""
    echo "=== Tier 2: deploy/ IaC validation (runtime-contract + posture + convergence) ==="
