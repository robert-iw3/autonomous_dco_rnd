...
Inherits the session-scoped `connector_dir` param (nsg/activity/entraid)
...
def _plugin_cache(tmp_path_factory):
    # Share provider downloads across all three connectors to avoid
    # re-pulling the azurerm provider on every init.
